...
namespace CarWare.Infrastructure.Migrations
{
    ...
    [Migration("20260525114946_addWorkingFromAndWorkingToAttributesInServiceCenterEntity")]
    partial class addWorkingFromAndWorkingToAttributesInServiceCenterEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarWare.Domain.Entities.Appointment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("MaintenanceReminderId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MaintenanceReminderId");
            ...
            modelBuilder.Entity("CarWare.Domain.Entities.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarWare.Domain.Entities.ServiceCenter", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Provider 1",
                            Phone = "0123456789",
                            WorkingFrom = new TimeSpan(0, 0, 0, 0, 0),
                            WorkingTo = new TimeSpan(0, 0, 0, 0, 0)
                        },
                        new
                        {
                            Id = 2,
            ...
            modelBuilder.Entity("CarWare.Domain.Entities.Slot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarWare.Domain.Entities.Appointment", b =>
                {
                    b.HasOne("CarWare.Domain.Entities.MaintenanceReminder", "MaintenanceReminder")
                        .WithMany()
                        .HasForeignKey("MaintenanceReminderId");
                    ...
                    b.Navigation("MaintenanceReminder");
            ...
            modelBuilder.Entity("CarWare.Domain.Entities.ServiceRequest", b =>
                {
                    ...
                    b.HasOne("CarWare.Domain.Entities.ApplicationUser", "Technician")
                        .WithMany("HandledServiceRequests")
            ...
            modelBuilder.Entity("CarWare.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.Navigation("HandledServiceRequests");
